...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_sngm.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_sngm"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_sngm:externalType",
                '',
                data)
        return extRecord
