...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.snowgemelectrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.snowgemelectrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.snowgemelectrum:externalType",
                '',
                data)
        return extRecord
