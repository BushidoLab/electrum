...
echo "Creating python Electrum-SNG.app and .dmg"
sudo hdiutil create -fs HFS+ -volname "Electrum SNG" -srcfolder "dist/Electrum SNG.app" dist/electrum-sng-$VERSION-macosx.dmg
